...
float Utils::get_value(float x, float y, float z, Configuration& configuration) {
    const float factor = configuration.noise_divisor;
    const float amplitude = configuration.noise_amplitude;
